  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-6 mt-20">
        {/* Notice Bar */}
        <div className="flex justify-between items-center border rounded-md p-3 text-sm bg-gray-50 w-[65rem]">
        ...
        <div className="flex mt-10 gap-8">
          <div className="text-xl border-b-4 border-green-500">OverView</div>
