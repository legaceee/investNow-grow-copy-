...
export default function MiddleModal() {
  return (
    <div className="flex justify-center items-center w-full px-4 sm:px-6 mt-6 sm:mt-10">
      <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-4 sm:p-8 max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* Left Side */}
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button className="bg-gray-800 text-white px-4 py-2 rounded-lg text-sm hover:bg-gray-700 w-full sm:w-auto">
                SEND LINK
              </button>
            </div>
          </div>
